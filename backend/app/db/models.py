...
class Order(Base):
    ...
    created_at = Column(DateTime, default=datetime.utcnow)
    status = Column(String(50), default="Active")  # Active, Pending Cancellation, Cancelled, Rejected
    cancellation_requested = Column(Integer, default=0)  # 0=no, 1=yes
    cancellation_reason = Column(String(1000), nullable=True)
    cancellation_note = Column(String(1000), nullable=True)
...
class PaymentReminder(Base):
    """Reminders for internal tracking of vendor payments"""
    __tablename__ = "payment_reminders"
    id = Column(Integer, primary_key=True)
    vendor_payment_id = Column(Integer, ForeignKey("vendor_payments.id"), nullable=True)
    ...
    reminder_type = Column(String(50), default="Payment Due")
    created_at = Column(DateTime, default=datetime.utcnow)
